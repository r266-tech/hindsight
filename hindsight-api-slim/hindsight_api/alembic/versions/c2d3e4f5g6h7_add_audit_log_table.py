...
Merge migration that also combines the three current heads.
...
Revises: a3b4c5d6e7f8, c8e5f2a3b4d1, a2b3c4d5e6f8
...
down_revision: str | Sequence[str] | None = ("a3b4c5d6e7f8", "c8e5f2a3b4d1", "a2b3c4d5e6f8")
