...
| `HINDSIGHT_API_LLM_BEDROCK_SERVICE_TIER` | AWS Bedrock service tier: `flex`, `priority`, or `reserved` | None (default) |
...
# Optional: Use Bedrock Flex for lower-cost background work
